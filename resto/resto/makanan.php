...
// Ambil data makanan
$sql = "SELECT * FROM products WHERE category = 'makanan' AND status = 'active' ORDER BY name";
...
<head>
    ...
    <title>Menu Makanan - TOKO ENCANG</title>
...
<body>
    ...
    <!-- Makanan Section -->
    <section class="container" id="makanan">
        <h2 class="section-title">Menu Makanan</h2>
        <div class="products" id="foodProducts">
            <?php if (count($food_products) > 0): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p class="no-products">Belum ada makanan. Silakan login sebagai admin untuk menambahkan produk.</p>
            <?php endif; ?>
        </div>
    </section>
